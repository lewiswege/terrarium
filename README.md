...
<p>This single-page game is implemented in JavaScript, which handles the main logic of the application</p>

<h3>How To Use</h3>
<ul>
  <li>Clone the repository through your terminal using git</li>
  <li>Or access it directly from the web through the following link  https://lewiswege.github.io/terrarium/main.html</li>
